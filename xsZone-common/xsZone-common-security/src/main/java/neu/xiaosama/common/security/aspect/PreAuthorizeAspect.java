package neu.xiaosama.common.security.aspect;
...
import neu.xiaosama.common.core.exception.PreAuthorizeException;
...
public class PreAuthorizeAspect
{
    ...
    @Around("@annotation(neu.xiaosama.common.security.annotation.PreAuthorize)")
